    ...
    <div className={s.device} data-pj-media="">
      {shot ? (
        ...
        <div className={s.productFallback} style={{ background: bg }}>
          ...
          <div className={s.deviceTag} style={{ color: fg, opacity: 0.7 }}>
            App preview
          </div>
        </div>
      )}
      ...
      <div className={s.pjBody}>
        ...
        >
          <Badge
            ...
            className={
              p.tone === "gold" ? s.darkBadgeWarning : s.darkBadgeAccent
            }
          >
            {p.category}
          </Badge>
          <Badge variant="neutral" className={s.darkBadgeNeutral}>
            {p.year}
          </Badge>
        </div>
        <h3
        ...
        >
          {p.title}{" "}
          {p.featuredIcon ? (
            <span className={s.featuredProjectTitleIcon} aria-hidden="true">
              <ImageLazy
                src={p.featuredIcon}
                alt=""
                width={40}
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          ...
          <Button
            variant={p.website ? "ghost" : "primary"}
            className={p.website ? "" : s.btnGlow}
            as="a"
            href={`/projects/${p.id}`}
    ...
    >
      ...
      <div className={s.wrap} style={{ position: "relative", zIndex: 1 }}>
        <SectionHead
          ...
          sub="A few of the projects we've designed and engineered end to end."
        />
